"""
Django settings for gopadel_backend project.
...
REST_FRAMEWORK = {
    ...
    # activar para que toda la app NO requiera autenticación
    'DEFAULT_AUTHENTICATION_CLASSES': [],
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny',
    ],
    #Activar para que toda la app requiera autenticación
    # 'DEFAULT_AUTHENTICATION_CLASSES': [
    #     'rest_framework_simplejwt.authentication.JWTAuthentication',
    # ],
    # # Opcional: si querés exigir auth por defecto en toda la API
    # 'DEFAULT_PERMISSION_CLASSES': [
